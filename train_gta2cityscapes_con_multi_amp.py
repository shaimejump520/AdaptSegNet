...
writer = {
          'train': SummaryWriter(log_dir='runs/train_Con_multi_amp_'+path_detail),
          'test':  SummaryWriter(log_dir='runs/test_Con_multi_amp_'+path_detail)
         }
...
#                              crop_transform=RandomCrop(int(768*(args.scale/1024))),
    ...
    [model, model_D2, model_D2], [optimizer, optimizer_D1, optimizer_D2] = amp.initialize(
        [model, model_D2, model_D2], [optimizer, optimizer_D1, optimizer_D2], 
        opt_level="O1", num_losses=7)
...
# python train_gta2cityscapes_con_multi_amp.py --snapshot-dir=./snapshots/con_multi_amp/ --gpu=0
